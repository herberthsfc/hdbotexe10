...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Herberth\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5511996237647:+55 1199623-7647\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/'
blocked = []
		...
		try {
			...
			switch(command) {
				...
				case 'info':
                    ...
                    client.sendMessage(from, 'Contato do meu criador, enviado com sucesso✔️',MessageType.text, { quoted: mek} )
                    break
				case 'blocklist':
